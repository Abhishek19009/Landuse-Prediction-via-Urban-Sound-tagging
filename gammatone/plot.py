...
def render_audio_from_file(path, duration, function, landuse_class):
    """
...
def take_input(audio, landuse_class):
    """
    ...
    """
    return render_audio_from_file(audio, 10, gammatone.fftweight.fft_gtgram, landuse_class)
